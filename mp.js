...
function countdown (element) {
	var Month = 0, Day = 0, day = 0, Hour = 0, Minute = 0, Seconds = 0, dayoffset1 = 8,  dayoffset2 = 15,  timeoffset = 12, temp, isStreaming = false, ChosenMonth = 7, JulyHour1 = 0, JulyHour2 = 0, starttime = 19;
